...
PERIODIC                                     # enables periodic boundary conditions
...
PMGRID=                                   # basic mesh size for TreePM calculations
ASMTH=2.00                                   # sets the smoothing of the PM force and thus the split-scale between Tree/FMM force and PM force
